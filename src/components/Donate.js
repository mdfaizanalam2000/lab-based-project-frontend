                    ...
                    <div class="col-md-6 offset-md-3 form-container">
                        ...
                        <form class="form-group" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                Male<input type="radio" name="gender" id="gender" value="Male" style={{ marginLeft: "10px", "margin-right": "10px" }} checked />
                                Fe-male<input type="radio" name="gender" id="gender" value="Fe-male" style={{ marginLeft: "10px" }} />
                            </div>
                            <div class="form-inline">
                                <label for="name">Date of Birth</label><br />
                                <select class="form-control demo-default" id="date" name="date" style={{ marginBottom: "10px" }} required>
                                ...
                                <select class="form-control demo-default" name="month" id="month" style={{ marginBottom: "10px" }} required>
                                    <option value="">---Month---</option>
                                    <option value="01" >January</option><option value="02" >February</option><option value="03" >March</option><option value="04" >April</option><option value="05" >May</option><option value="06" >June</option><option value="07" >July</option><option value="08" >August</option><option value="09" >September</option><option value="10" >October</option><option value="11" >November</option><option value="12" >December</option>
                                </select>
                                <select class="form-control demo-default" id="year" name="year" style={{ marginBottom: "10px" }} required>
                            ...
                            <div class="form-inline">
                                <input type="checkbox" name="term" value="true" required style={{ marginLeft: "10px" }} />
                                <span style={{ marginLeft: "10px" }}><b>I am agree to donate my blood and show my Name, Contact Nos. and E-Mail in Blood donors List</b></span>
                            </div>
